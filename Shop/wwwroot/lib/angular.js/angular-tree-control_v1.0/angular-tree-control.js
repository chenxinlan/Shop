                ...
                controller: ['$scope', '$templateCache', '$interpolate', 'treeConfig', function( $scope, $templateCache, $interpolate, treeConfig ) {
                    ...
                    if(!template) {
                        template =
                            ...
                            'set-node-to-data>' +
                            '<div class="li_out"   ng-class="[selectedClass(), unselectableClass()]"  ><i class="tree-branch-head" ng-class="iBranchClass()" ng-click="selectNodeHead(node)"></i>' +
                            '<i class="tree-leaf-head {{options.iLeafClass}}"></i>' +
                            '<div class="tree-label {{options.labelClass}}" ng-click="selectNodeLabel(node)"  tree-transclude></div></div>' +
                            '<treeitem ng-if="nodeExpanded()" class="ct_item"></treeitem>' +
                            '</li>' +
                            '</ul>';
                    }
